...
import { gymData } from "./MarketplaceData";

const classifiedData = gymData;

const INDIAN_STATES = [
  "Delhi", "Maharashtra", "Punjab", "Haryana", "Karnataka", "Tamil Nadu", "Gujarat"
];
...
const GymEquipmentsSupplier = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/gym1.jpg" },
    { label: "Cardio",   img: "/assets/gym2.jpg" },
    { label: "Strength", img: "/assets/gym3.jpg" },
    { label: "Weights",  img: "/assets/gym1.jpg" },
    { label: "Yoga",     img: "/assets/gym2.jpg" },
  ];
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              ...
              <div className="checkbox-group">
                {["Treadmills", "Dumbbells", "Benches", "Cycles", "Racks", "Mats"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">FITNESS PRO</div>
            <h3>Premium Gym Hub</h3>
            <p>Direct from top manufacturers in Meerut and Ludhiana. Commercial grade gym equipment and fitness accessories.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/gym1.jpg"} />
                </div>
                ...
                <div className="product-card" key={index}>
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to="/register-buyer" className="btn-primary">Get Quotes</Link>
                    </div>
                  </div>
                </div>
              ))}
