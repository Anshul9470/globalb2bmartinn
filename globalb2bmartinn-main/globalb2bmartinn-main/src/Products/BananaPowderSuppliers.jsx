...
const classifiedData = [
  {
    ...
    productOrService: "Banana Powder Exporter",
    imgSrc: "/assets/axim1.jpeg",
    mainProducts: "Alphonso Mango Pulp, Banana Powder, Fruit Powders",
    years: "1 YRS",
  ...
  },
  {
    ...
    imgSrc: "/assets/bana1.jpg",
    mainProducts: "Organic Banana Powder, Natural Banana Powder, Instant Banana Powder",
    years: "1 YRS",
  ...
  },
  {
    ...
    productOrService: "Banana Powder",
    imgSrc: "/assets/bnp.jpg",
    mainProducts: "Premium Banana Powder, Export Quality Powder",
    years: "1 YRS",
  ...
  },
  {
    ...
    productOrService: "Fruit & Vegetable Powder",
    imgSrc: "/assets/bana2.jpg",
    mainProducts: "Organic Banana Powder, Dehydrated Fruit Powders",
    years: "1 YRS",
...
const BananaPowderSuppliers = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/axim1.jpeg" },
    { label: "Organic",  img: "/assets/bana1.jpg" },
    { label: "Natural",  img: "/assets/bana2.jpg" },
    { label: "Instant",  img: "/assets/bana3.jpg" },
  ];
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              ...
              <div className="checkbox-group">
                {["Organic", "Natural", "Instant", "Dehydrated"].map(type => (
          ...
          <div className="pro-ad-card">
            ...
            <h3>VDS Global</h3>
            <p>Premium grade banana powder and mango pulp for international markets.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/bana1.jpg"} />
                </div>
