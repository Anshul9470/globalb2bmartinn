...
import { footwearData } from "./MarketplaceData";

const classifiedData = footwearData;

const INDIAN_STATES = [
  "Maharashtra", "Delhi", "Tamil Nadu", "Karnataka", "Punjab", "Uttar Pradesh", "Gujarat"
];
...
const FootwearDealers = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/footwear1.jpeg" },
    { label: "Men",      img: "/assets/footwear3.jpeg" },
    { label: "Women",    img: "/assets/footwear5.jpeg" },
    { label: "Sports",   img: "/assets/footwear2.jpeg" },
    { label: "Formal",   img: "/assets/footwear4.jpeg" },
  ];
        ...
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Footwear Type</label>
              <div className="checkbox-group">
                {["Men", "Women", "Sports", "Formal", "Casual", "Safety"].map(type => (
            ...
            <div className="filter-group">
              <label className="filter-label">State / City</label>
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">STEP PRO</div>
            <h3>Premium Footwear Hub</h3>
            <p>Direct from top manufacturers in Agra and Kanpur. Bulk supply of leather shoes and sports footwear.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/footwear1.jpeg"} />
                </div>
