...
import { utensilsData } from "./MarketplaceData";

const classifiedData = utensilsData;

const INDIAN_STATES = [
  "Gujarat", "Maharashtra", "Tamil Nadu", "Delhi", "Rajasthan", "Karnataka", "Punjab"
];
...
const Utensils = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/utensils1.jpg" },
    { label: "Steel",    img: "/assets/utensils2.jpg" },
    { label: "Cookware", img: "/assets/utensils3.jpg" },
    { label: "Dinnerware", img: "/assets/utensils1.jpg" },
    { label: "Kitchen",  img: "/assets/utensils2.jpg" },
  ];
        ...
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Utensil Material</label>
              <div className="checkbox-group">
                {["Stainless Steel", "Copper", "Aluminium", "Brass", "Non-Stick", "Ceramic"].map(type => (
            ...
            <div className="filter-group">
              <label className="filter-label">Manufacturing City</label>
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">STEEL PRO</div>
            <h3>Elite Utensils Hub</h3>
            <p>Direct from top manufacturers in Ahmedabad and Rajkot. High-grade stainless steel cookware and dinnerware.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/utensils1.jpg"} />
                </div>
                ...
                <div className="product-card" key={index}>
                  <div className="card-image-wrapper">
                    ...
                    <div className="badge-overlay">
                      <span className="verified-badge">
                        <FontAwesomeIcon icon={faCheckCircle} /> VERIFIED MANUFACTURER
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to="/register-buyer" className="btn-primary">Inquiry Now</Link>
                    </div>
                  </div>
                </div>
              ))}
