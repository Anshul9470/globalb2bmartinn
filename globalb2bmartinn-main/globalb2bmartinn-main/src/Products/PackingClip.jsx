...
const classifiedData = [
  {
    ...
    productOrService: "Adhesive Tapes",
    imgSrc: "/assets/craft5.webp",
    mainProducts: "Adhesive Tapes, Specialty Tapes, Packing Tapes",
    years: "1 YRS",
  ...
  },
  {
    ...
    mainProducts: "Packaging Solutions, Clips, Straps",
    years: "1 YRS",
  ...
  },
  {
    ...
    imgSrc: "/assets/clips.jpg",
    mainProducts: "Metal packing clips, Plastic packing clips, Sealing clips",
    years: "1 YRS",
  ...
  },
  {
    ...
    imgSrc: "/assets/packi.jpeg",
    mainProducts: "Bubble Wrap, Packing Peanuts, Stretch Film",
    years: "1 YRS",
  ...
  },
  {
    ...
    productOrService: "Strapping Rolls",
    imgSrc: "/assets/strap.jpeg",
  ...
  },
  {
    ...
    productOrService: "Box Manufacturer",
    imgSrc: "/assets/box3.jpeg",
    mainProducts: "Corrugated Boxes, Heavy Duty Cartons",
    years: "1 YRS",
    location: "Mumbai, Maharashtra",
    rating: "4.7",
  },
...
const PackingClipsComponent = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/clips.jpg" },
    { label: "Clips",    img: "/assets/clip1.jpg" },
    { label: "Tapes",    img: "/assets/tape9.jpg" },
    { label: "Boxes",    img: "/assets/box1.jpeg" },
    { label: "Wraps",    img: "/assets/packi.jpeg" },
  ];
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              ...
              <div className="checkbox-group">
                {["Clips", "Tapes", "Boxes", "Straps", "Wraps"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">PACKAGING PRO</div>
            <h3>SafeShip Solutions</h3>
            <p>End-to-end packaging materials. Boxes, tapes, and protective wraps at factory rates.</p>
            <Link to="/packages" className="upgrade-link">Contact Now &gt;</Link>
          </div>
        </aside>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/clips.jpg"} />
                </div>
                ...
                <div className="product-card" key={index}>
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to="/register-buyer" className="btn-primary">Contact Supplier</Link>
                    </div>
                  </div>
                </div>
              ))}
