...
import { industrialData } from "./MarketplaceData";

const classifiedData = industrialData;

const INDIAN_STATES = [
  "Maharashtra", "Gujarat", "Tamil Nadu", "Karnataka", "Delhi", "Punjab", "Haryana", "Uttar Pradesh"
];
...
const MachineManufacturer = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/indus5.webp" },
    { label: "CNC",      img: "/assets/indus6.jpg" },
    { label: "Lathe",    img: "/assets/indus1.jpg" },
    { label: "Hydraulic", img: "/assets/indus2.jpg" },
    { label: "Tools",    img: "/assets/indus3.jpg" },
  ];
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              ...
              <div className="checkbox-group">
                {["CNC", "Lathe", "Hydraulic", "Milling", "Drilling", "Grinding"].map(type => (
            ...
            <div className="filter-group">
              <label className="filter-label">Industrial Hub</label>
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">INDUSTRY PRO</div>
            <h3>Heavy Machinery Hub</h3>
            <p>Direct from top manufacturers in Pune, Ludhiana and Coimbatore. High-precision CNC and industrial machines.</p>
            <Link to="/packages" className="upgrade-link">Get Quotes &gt;</Link>
          </div>
        </aside>
