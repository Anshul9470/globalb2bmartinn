...
import { homeSuppliesData } from "./MarketplaceData";

const classifiedData = homeSuppliesData;

const INDIAN_STATES = [
  "Rajasthan", "Uttar Pradesh", "Delhi", "Gujarat", "Maharashtra", "Tamil Nadu", "Karnataka"
];
...
const HomeDecor = () => {
  ...
  const categories = [
    { label: "All",      img: "/assets/home1.jpg" },
    { label: "Curtains", img: "/assets/home2.jpg" },
    { label: "Cushions", img: "/assets/homedecor1.jpg" },
    { label: "Rugs",     img: "/assets/homedecor2.jpg" },
    { label: "Wall Art", img: "/assets/home1.jpg" },
  ];
        ...
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Decor Type</label>
              <div className="checkbox-group">
                {["Curtains", "Cushions", "Rugs", "Wall Art", "Lighting", "Furniture"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">DECOR PRO</div>
            <h3>Premium Home Hub</h3>
            <p>Direct from artisan hubs in Jaipur and Panipat. High-quality home furnishings and decorative items for wholesale.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/home1.jpg"} />
                </div>
                ...
                <div className="product-card" key={index}>
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-actions">
                      <Link to="/register-buyer" className="btn-primary">Order Sample</Link>
                    </div>
                  </div>
                </div>
              ))}
