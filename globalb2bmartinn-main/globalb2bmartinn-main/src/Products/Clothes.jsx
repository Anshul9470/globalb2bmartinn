...
import { fashionData } from "./MarketplaceData";

const classifiedData = fashionData;

const INDIAN_STATES = [
  "Delhi", "Maharashtra", "West Bengal", "Tamil Nadu", "Gujarat", "Karnataka", "Punjab"
];
...
const Clothing = () => {
  ...
  const clothingCategories = [
    ...
    { label: "Men",      img: "/assets/clothing2.jpg" },
    { label: "Kids",     img: "/assets/clothing3.jpg" },
    { label: "Ethnic",   img: "/assets/clothing4.jpg" },
    { label: "Western",  img: "/assets/clothing5.jpg" },
  ];
        ...
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Clothing Type</label>
              <div className="checkbox-group">
                {["Women", "Men", "Kids", "Ethnic", "Western", "Casual", "Formal"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">STYLE PRO</div>
            <h3>Fashion Sourcing</h3>
            <p>Direct from manufacturers. Wholesale rates for latest trends and ethnic wear.</p>
