...
import { pulsesData } from "./MarketplaceData";

const classifiedData = pulsesData;

const INDIAN_STATES = [
  "Maharashtra", "Punjab", "Uttar Pradesh", "Karnataka", "Madhya Pradesh", "Rajasthan"
];
...
const PulsesDealer = () => {
  ...
  const categories = [
    { label: "All",       img: "/assets/pul1.jpeg" },
    { label: "Lentils",   img: "/assets/pul2.jpeg" },
    { label: "Chickpeas", img: "/assets/pul3.jpeg" },
    { label: "Beans",     img: "/assets/pul4.jpeg" },
    { label: "Peas",      img: "/assets/pul5.jpeg" },
  ];
        ...
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Pulse Type</label>
              <div className="checkbox-group">
                {["Lentils", "Chickpeas", "Beans", "Peas", "Grains"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">GRAIN PRO</div>
            <h3>Bulk Pulse Hub</h3>
            <p>Direct from top processing plants. Export quality lentils and chickpeas at wholesale prices.</p>
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/pul1.jpeg"} />
                </div>
