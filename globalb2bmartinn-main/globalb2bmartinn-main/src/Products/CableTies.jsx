...
import { cableTieData } from "./MarketplaceData";

const INDIAN_STATES = [
  "Maharashtra", "Gujarat", "Rajasthan", "Uttar Pradesh", "Karnataka", "Haryana",
  "Delhi", "Tamil Nadu", "West Bengal", "Punjab", "Madhya Pradesh"
];
...
const CableTies = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${apiEndpoint}/products/category/Cable Ties`);
        setDbProducts(res.data);
        setFilteredData([...cableTieData, ...res.data]);
      } catch (err) {
        console.error("Failed to fetch products:", err);
        setFilteredData(cableTieData);
      }
    };
    fetchProducts();
  }, []);
  ...
  const handleApplyFilters = () => {
    let result = [...cableTieData, ...dbProducts];
  ...
  const resetFilters = () => {
    setSelectedCats([]);
    setLocationQuery("");
    setFilteredData([...cableTieData, ...dbProducts]);
    setActiveChip("All");
  };
  ...
  const handleCategoryChip = (cat) => {
    ...
    const result = [...cableTieData, ...dbProducts].filter(item =>
  ...
  const categories = [
    { label: "All",      img: "/assets/cable_tie_main.png" },
    { label: "Nylon",    img: "/assets/cable_tie_main.png" },
    { label: "Plastic",  img: "/assets/cable_tie_main.png" },
    { label: "Security", img: "/assets/cable_tie_main.png" },
    { label: "UV-Ties",  img: "/assets/cable_tie_main.png" },
  ];
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              ...
              <div className="checkbox-group">
                {["Nylon", "Plastic", "Stainless Steel", "Security", "UV Resistant"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">AZOLIYA PRO</div>
            <h3>Azoliya (NRP Plast)</h3>
            <p>Premium quality nylon cable ties and security seals at competitive prices. Contact Mr. Rohit Patel.</p>
            <Link to="/register-buyer" className="upgrade-link">Contact Now &gt;</Link>
          </div>
        </aside>
        ...
        <main className="content-area">
            ...
            {categories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/cable_tie_main.png"} />
                </div>
          ...
          <div className="results-header">
            <h1>Cable Tie & Security Seal Suppliers</h1>
            <p>{filteredData.length} Suppliers matching your criteria</p>
          </div>
                ...
                <div className="product-card" key={index}>
                  ...
                  <div className="card-body">
                    ...
                    <div className="supplier-section">
                      ...
                      <div className="supplier-meta-grid">
                        <span className="location-tag">
                          <FontAwesomeIcon icon={faMapMarkerAlt} /> {item.location || item.city || item.seller?.cityname || "N/A"}
                        </span>
                    ...
                    <div className="card-actions">
                      <Link to={`/products/${item._id}`} className="btn-quick-quote">View Detail</Link>
