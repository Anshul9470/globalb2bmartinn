...
import CableTies from "./Products/CableTies";
      ...
      <div className="App">
        ...
        <div className={isStandaloneRoute ? "" : "mainContent"}>
          ...
          <Routes>
            ...
            <Route path="/buyer/:categoryName" element={<DynamicBuyerWrapper />} />
            <Route path="/buyers/:categoryName" element={<DynamicBuyerWrapper />} />
            <Route
            ...
            <Route path="wheatsupplier" element={<WheatSupplier />} />
            <Route
            ...
            <Route path="azoliya-cable-tie" element={<CableTies />} />
...
function SearchResultsWrapper() {
  ...
  return <SearchResults forcedQuery={decodedKeyword} />;
}
