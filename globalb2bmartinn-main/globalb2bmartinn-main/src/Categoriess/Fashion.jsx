...
import { fashionData } from "../Products/MarketplaceData";

const classifiedData = fashionData;

const INDIAN_STATES = [
  "Tamil Nadu", "Maharashtra", "Delhi", "Uttar Pradesh", "West Bengal", "Gujarat", "Karnataka"
];
...
const Fashion = () => {
  ...
  const fashionCategories = [
    { label: "All",      img: "/assets/app2.jpg" },
    { label: "Ethnic",   img: "/assets/saree1.jpg" },
    { label: "Casual",   img: "/assets/gbgarment1.jpg" },
    { label: "Formal",   img: "/assets/formal.jpg" },
    { label: "Kids",     img: "/assets/kids.jpg" },
    { label: "Women",    img: "/assets/clothing.jpg" },
  ];

  return (
    <div className="marketplace-container">
      <Helmet>
        <title>Apparel & Clothing Suppliers | GlobalB2BMart</title>
      </Helmet>
      ...
      <div className="marketplace-layout">
        <aside className="filters-sidebar">
          ...
          <div className="filter-group-container">
            <div className="filter-group">
              <label className="filter-label">Apparel Type</label>
              <div className="checkbox-group">
                {["Ethnic", "Casual", "Formal", "Kids", "Women", "Men"].map(type => (
          ...
          <div className="pro-ad-card">
            <div className="pro-badge">TOP RATED</div>
            <h3>Textile Hub India</h3>
            <p>Connect with the best apparel manufacturers from Surat, Mumbai and Tirupur hubs.</p>
            <Link to="/packages" className="upgrade-link">View Pricing &gt;</Link>
          </div>
        </aside>
        ...
        <main className="content-area">
            ...
            {fashionCategories.map((cat) => (
              ...
              >
                <div className="chip-img-ring">
                  <img src={cat.img} alt={cat.label} onError={(e) => e.target.src="/assets/app2.jpg"} />
                </div>
          ...
          <div className="results-header">
            <h1>Apparel & Clothing Suppliers</h1>
            <p>{filteredData.length} Manufacturers and Wholesalers</p>
          </div>
