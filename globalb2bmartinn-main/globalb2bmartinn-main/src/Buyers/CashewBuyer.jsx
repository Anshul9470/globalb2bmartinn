...
// Sample random data for cashew buyers
const CashewBuyers = [
  {
    ...
    lookingFor: "Bulk Purchase: Raw Cashew Nuts",
    locationandDate: "Delhi, 08-11-2024",
    productOrService: "Cashew Supplier",
    quantity: 1000,
    unit: "kg",
  },
  {
    ...
    mobileNumber: "9923456781",
    lookingFor: "Bulk Purchase: Roasted Cashews",
  ...
  },
  {
    ...
    name: "Ankit Agarwal",
    email: "ankit.agarwal@gmail.com",
    mobileNumber: "9765432189",
    lookingFor: "Bulk Purchase: Cashew Kernels",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: Organic Cashew Nuts",
    locationandDate: "Ahmedabad, 07-11-2024",
    productOrService: "Cashew Supplier",
    quantity: 1200,
    unit: "kg",
  },
  {
    ...
    name: "Vikash Reddy",
    email: "vikash.reddy@gmail.com",
    mobileNumber: "9982345678",
    lookingFor: "Bulk Purchase: Cashew Nut Splits",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: Cashew Nuts for Processing",
...
const CashewBuyer = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`cashewViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `cashewViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = CashewBuyers[index]; // Get the buyer information
    ...
    <>
      <div className="container">
        <ol className="breadcrumb">
          ...
          <li>/</li>
          <li className="breadcrumb-item active">Cashew Leads</li>
        </ol>
      </div>
