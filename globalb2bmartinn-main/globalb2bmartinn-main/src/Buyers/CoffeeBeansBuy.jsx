...
const CoffeeBeansBuys = [
    {
        "name": "Amatullah",
        "email": "amatullahbohra5@gmail.com",
        "mobileNumber": "8619294839",
        "locationandDate": "Wayanad, 10-08-2024",
        "lookingFor": "Looking for premium Coffee Beans suppliers!",
        "productOrService": "Coffee Beans",
        "quantity": 10,
        "unit": "ton",
        "_id": "unique_id_for_coffee_beans_buyer"
    },
    {
        "name": "RAVI, PRASAD",
        "email": "raviprasad413@gmail.com",
        "mobileNumber": "9482589266",
        "lookingFor": "Fresh beans urgently required",
        "productOrService": "Coffee Bean",
        "locationandDate": "Kerala, 10-08-2024",
        "quantity": 50,
        "unit": "ton"
    },
    {
        "name": "Pavan",
        "email": "pavani.ram0410@gmail.com",
        "mobileNumber": "9618213968",
        "lookingFor": "Aromatic beans of coffee Required",
        "productOrService": "coffee beans",
        "locationandDate": "Idukki, 09-08-2024",
        "quantity": 2,
        "unit": "ton"
    }
...
const CoffeeBeansBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`coffeeBeansViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`coffeeBeansViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = CoffeeBeansBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {CoffeeBeansBuys.map((buyer, index) => (
