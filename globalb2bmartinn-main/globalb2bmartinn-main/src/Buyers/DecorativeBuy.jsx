...
const DecorativeItemBuys = [
    {
        "name": "Kalakriti",
        "email": "balajiexports72@yahoo.co.in",
        "mobileNumber": "9828541703",
        "locationandDate": "29-06-2024",
        "lookingFor": "Decorative items",
        "productOrService": "Decorative items",
        "quantity": 1000,
        "unit": "pcs",
        "_id": "667c0f639644befaa9548019"
    },
    {
        "name": "Rajiv Tekwani",
        "email": "rajivt73@yahoo.com",
        "mobileNumber": "9717995740",
        "locationandDate": "29-06-2024",
        "lookingFor": "Decorative Products Urgently",
        "productOrService": "Decorative items",
        "quantity": 1000,
        "unit": "pcs"
    }
...
const DecorativeItemBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`decorativeItemViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`decorativeItemViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = DecorativeItemBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        <h3>All Category</h3>
                        <li><Link to="#">Decorative Items</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {DecorativeItemBuys.map((buyer, index) => (
...
export default DecorativeItemBuy;
