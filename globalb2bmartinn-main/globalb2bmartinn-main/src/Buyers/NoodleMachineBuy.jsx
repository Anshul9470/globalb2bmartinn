...
const NoodleMachineBuys = [
    {
        ...
        "locationandDate": "Kolkata 11-08-2024",
...
const NoodleMachineBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`noodleMachineViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`noodleMachineViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = NoodleMachineBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {NoodleMachineBuys.map((buyer, index) => (
...
export default NoodleMachineBuy;
