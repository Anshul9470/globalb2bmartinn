...
const CorianderLeavesBuys = [
    {
        "name": "Mudasir Ahmad Bhat",
        "email": "janheemu23@gmail.com",
        "mobileNumber": "6006990671",
        "lookingFor": "Coriander Leaves",
        "locationandDate": "Jammu and Kashmir 05-07-2024",
        "productOrService": "Coriander Leaves",
        "quantity": 200,
        "unit": "kg"
    },
    {
        "name": "Rejani",
        "email": "rejaniselvakumar@gmail.com",
        "mobileNumber": "9003631075",
        "locationandDate": "tamil nadu, 5/07/2024",
        "productOrService": "coriander leaves",
        "quantity": 20,
        "unit": "Ton",
        "lookingFor": "coriander leaves Urgently Required",
        "_id": "667c0f639644befaa9548015"
    }

];

const CorianderLeavesBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`corianderViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`corianderViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = CorianderLeavesBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {CorianderLeavesBuys.map((buyer, index) => (
...
export default CorianderLeavesBuy;
