...
const products = [
  {
    ...
    items: ["Chickpeas", "Green Moong", "Red Lentils", "Toor Dal"],
  ...
  },
  {
    ...
    items: ["Silk Saree", "Cotton Saree", "Party Wear", "Bridal Saree"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/sareesdealer",
  },
  {
    ...
    items: ["Basmati Rice", "Non-Basmati", "Brown Rice", "Jasmine Rice"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/rice-seller",
  },
  {
  ...
  },
  {
    ...
    items: ["Rigid PVC", "Conduit Pipes", "Agri Pipes", "Plumbing Pipes"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/pipeseller",
  },
  {
    ...
    items: ["Black Pepper", "Turmeric", "Cumin Seeds", "Cardamom"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/spices-dealers",
  },
  {
    ...
    items: ["Wooden Decor", "Brass Items", "Metal Art", "Marble Statues"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
  ...
  },
  {
    ...
    items: ["Aloe Vera", "Ashwagandha", "Neem Leaves", "Herbal Oils"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/hearbal-seller",
  },
  {
    ...
    items: ["Bottles", "Containers", "Furniture", "Industrial Parts"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
    path: "/plastic",
  },
  {
    ...
    items: ["Office Desks", "Living Room", "Bedroom Sets", "Outdoor"],
    trustPoints: ["120+ Verified Suppliers", "ISO 9001:2015 Cert.", "Global Export Quality"],
...
export default function Allcategory() {
  ...
  return (
    <>
          ...
          <Swiper
            ...
            breakpoints={{
              ...
              1024: {
                slidesPerView: 4,
                spaceBetween: 30,
                autoplay: false, /* Stop moving on desktop for professional look */
              },
            }}
      ...
      <section className="allcat-section" id="featured-products">
        ...
        <div className="premium-filter-container">
          <div className="filter-item">
            <div className="filter-img-ring">
              <img src="./assets/ai-pulses.jpg" alt="All" />
            </div>
            <span className="filter-label">All</span>
          </div>
          <div className="filter-item active">
            <div className="filter-img-ring">
              <img src="./assets/ricemain.png" alt="Rice" />
            </div>
            <span className="filter-label">Rice</span>
          </div>
          <div className="filter-item">
            <div className="filter-img-ring">
              <img src="./assets/fruitspowder.png" alt="Fruits" />
            </div>
            <span className="filter-label">Fruits</span>
          </div>
          <div className="filter-item">
            <div className="filter-img-ring">
              <img src="./assets/ai-cable-tie.jpg" alt="Industrial" />
            </div>
            <span className="filter-label">Industrial</span>
          </div>
        </div>

        <div className="category-grid">
          {products.map((product) => (
            <div className="category-card premium-animated" key={product.id}>
              <div className="category-img">
                <Link to={product.path || "/"}>
                  <img src={product.image} alt={product.title} />
                </Link>
              ...
              <div className="card-content">
                ...
                {product.trustPoints && (
                  <ul className="trust-points">
                    {product.trustPoints.map((point, idx) => (
                      <li key={idx}>{point}</li>
                    ))}
                  </ul>
                )}
                ...
                {product.items && (
                  <ul className="item-list sub-categories">
                    {product.items.map((item, idx) => (
                      <li key={idx}>
