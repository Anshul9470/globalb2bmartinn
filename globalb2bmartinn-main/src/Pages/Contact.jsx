                    ...
                    <div className="split-layout">
                        <div className="form-side">
                            <div className="glass-form-card">
                                ...
                                <form className="premium-compact-form">
                                    <div className="form-row-dual">
                                        <div className="f-input-group"><label>Name</label><input type="text" placeholder="Your Name" /></div>
                                        <div className="f-input-group"><label>Phone</label><input type="text" placeholder="Your Phone" /></div>
                                    </div>
                                    <div className="f-input-group"><label>Email</label><input type="email" placeholder="Your Email" /></div>
                                    <div className="f-input-group"><label>Message</label><textarea rows="4" placeholder="How can we help?"></textarea></div>
