...
const classifiedData = [
    {
        ...
        name: "ratan",
        email: "ratan@gamil.com",
        mobileNumber: "9463403351",
        companyName: "pigeon forexpvt",
        productOrService: "money exchange",
        imgSrc: "/assets/forr5.webp",  // You need to provide the correct image path
        mainProducts: "Currency Exchange, Money Transfer, Travel Money",
        altText: "Money Exchange - Pigeon Forex Pvt",
        years: "1 YRS",
        location: "Delhi, India",
        tooltipText: "123 Currency Exchange Building, Connaught Place, Delhi, India",
        rating: "4.5",
        ratingPercent: "90%",
        ratingsCount: "100",
        responseRate: "95%"
                    ...
                    <div className="flt-box bdrt-0">
                        ...
                        <div className="flt-content">
                            <ul className="flt-list cust-scroll">
                                <li><Link to="#">Currency Exchange</Link></li>
                                <li><Link to="#">Foreign Exchange</Link></li>
                                <li><Link to="#">Forex Services</Link></li>
                                <li><Link to="#">Money Transfer</Link></li>
                                <li><Link to="#">Travel Money</Link></li>
                                <li><Link to="#">Remittance Services</Link></li>
                    ...
                    <div className="horprd expcatg" id="expcatg">
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/forr2.jpg" width={55} height={55} alt="Currency Exchange" />
                                    </figure>
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/forr3.jpg" width={55} height={55} alt="Foreign Exchange" />
                                    </figure>
                                    <p className="title">Foreign Exchange</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/forr4.jpg" width={55} height={55} alt="Forex Services" />
                                    </figure>
                                    <p className="title">Forex Services</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/forr5.webp" width={55} height={55} alt="Money Transfer" />
                                    </figure>
                                    <p className="title">Money Transfer</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/forr2.jpg" width={55} height={55} alt="Travel Money" />
                                    </figure>
                                    <p className="title">Travel Money</p>
                                </div>
                            </Link>
                        </div>
                    </div>
