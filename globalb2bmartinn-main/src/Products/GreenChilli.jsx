...
const classifiedData = [
    {
        _id: "5678efgh9012ijkl",
        name: "Rahull Zatte",
        email: "abc@gmail.com",
        mobileNumber: "8805919012",
        companyName: "Kalpana Agro",
        productOrService: "Green Chillies",
        imgSrc: "/assets/green1.jpeg", // Update with the actual image path
        mainProducts: "Green Chillies",
        altText: "Green Chillies - Kalpana Agro",
        years: "3 YRS",
        location: "Wani, Maharashtra, India",
        tooltipText: "Wani, Maharashtra, India",
        rating: "4.0",
        ratingPercent: "80%",
        ratingsCount: "50",
        responseRate: "75%"
                    ...
                    <div className="flt-box bdrt-0">
                        ...
                        <div className="flt-content">
                            <ul className="flt-list cust-scroll">
                                <li><Link to="#">Green Chillies</Link></li>
                                <li><Link to="#">Fresh Vegetables</Link></li>
                                <li><Link to="#">Organic Produce</Link></li>
                    ...
                    <div className="horprd expcatg" id="expcatg">
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/green1.jpeg" width={55} height={55} alt="Green Chillies" />
                                    </figure>
                                    <p className="title">Green Chillies</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/organic1.jpeg" width={55} height={55} alt="Organic Produce" />
                                    </figure>
                                    <p className="title">Organic Produce</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/spices.jpg" width={55} height={55} alt="Spices" />
                                    </figure>
...
export default GreenChilliesProvider;
