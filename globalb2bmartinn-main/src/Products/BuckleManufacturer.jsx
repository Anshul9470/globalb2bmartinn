...
const classifiedData = [
    {
        ...
        mobileNumber: "8375857680",
        companyName: "HV Enterprises",
        productOrService: "Manufacturers of Buckles",
        imgSrc: "/assets/buckles.jpeg",  // Example image path, adjust as necessary
        altText: "Buckles - HV Enterprises",
        mainProducts: "Metal Buckles, Plastic Buckles, Belt Buckles",
        years: "1 YRS",
        location: "Delhi, India",  // Update with actual location if available
        tooltipText: "456 Buckle Street, Fastener City, Delhi, India",
        rating: "4.7",
        ratingPercent: "94%",
        ratingsCount: "350",
        responseRate: "89%",
                    ...
                    <div className="flt-box bdrt-0">
                        ...
                        <div className="flt-content">
                            <ul className="flt-list cust-scroll">
                                <li><Link to="#">Metal Buckles</Link></li>
                                <li><Link to="#">Plastic Buckles</Link></li>
                                <li><Link to="#">Belt Buckles</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/buck1.jpg" width={55} height={55} alt="Metal Buckles" />
                                    </figure>
                                    <p className="title">Metal Buckles</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/buck2.jpg" width={55} height={55} alt="Plastic Buckles" />
                                    </figure>
                                    <p className="title">Plastic Buckles</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/buck3.jpg" width={55} height={55} alt="Belt Buckles" />
                                    </figure>
                                    <p className="title">Belt Buckles</p>
                                </div>
                            </Link>
                        </div>
                    </div>
...
export default BuckleManufacturerStore;
