...
// Sample random data for handicraft item buyers
const HandicraftBuys = [
  {
    _id: "11223344556677889900",
    name: "Priya Sharma",
    email: "priya.sharma@gmail.com",
    mobileNumber: "9876543210",
    lookingFor: "Buying: Wooden Carvings",
    locationandDate: "Jaipur, 17-10-2024",
  ...
  },
  {
    ...
    lookingFor: "Need Handmade Pottery",
    locationandDate: "Bhopal, 16-10-2024",
  ...
  },
  {
    ...
    lookingFor: "Buying: Woven Handbags",
...
const HandicraftBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`handicraftViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `handicraftViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = HandicraftBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            <h3>All Category</h3>
            <li>
              <Link to="#">Wooden Items</Link>
            </li>
            <li>
              <Link to="#">Pottery</Link>
            </li>
            <li>
              <Link to="#">Handcrafted Bags</Link>
            </li>
            <li>
        ...
        <div className="buyers">
          {HandicraftBuys.map((buyer, index) => (
