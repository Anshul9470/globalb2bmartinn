...
const FennelSeedsBuys = [
    {
        "name": "Alwin",
        "email": "antonysagency@gmail.com",
        "mobileNumber": "7397560034",
        "lookingFor": "Seeking top-quality fennel seeds for immediate purchase.",
        "locationandDate": "Tirunelveli 09-07-2024",
        "productOrService": "fennel seeds",
        "quantity": 50,
        "unit": "kg",
        "__v": 0
    },
    {
        ...
        "lookingFor": "Looking for bulk quantity of fennel seeds.",
...
const FennelSeedsBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`fennelSeedsViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`fennelSeedsViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = FennelSeedsBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {FennelSeedsBuys.map((buyer, index) => (
