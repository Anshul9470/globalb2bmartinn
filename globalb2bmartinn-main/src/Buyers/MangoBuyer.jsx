...
import "./OnionBuy.css"; // Assuming you have a separate CSS file for the MangoBuyer component
...
const MangoBuyers = [
  {
    _id: "12345abcd67890efgh",
    name: "Ravi Kumar",
    email: "ravikumar@gmail.com",
    mobileNumber: "9123456789",
    lookingFor: "Fresh Mangoes",
    locationandDate: "Hyderabad 11-11-2024",
    productOrService: "Fresh Mangoes",
    quantity: 100,
    unit: "kg",
  },
  {
    _id: "67890abcd12345efgh",
    name: "Priya Gupta",
    email: "priyagupta@gmail.com",
    mobileNumber: "9812345670",
    lookingFor: "Ripe Mangoes",
    locationandDate: "Chennai 10-11-2024",
    productOrService: "Ripe Mangoes",
    quantity: 200,
    unit: "kg",
  },
  {
    _id: "23456abcd78901efgh",
    name: "Amit Sharma",
    email: "amitsharma@gmail.com",
    mobileNumber: "9345678901",
    lookingFor: "Fresh Mangoes for export",
    locationandDate: "Delhi 10-11-2024",
    productOrService: "Export Quality Mangoes",
    quantity: 500,
    unit: "kg",
  },
  {
    _id: "78901abcd23456efgh",
    name: "Sita Rao",
    email: "sitarrao@gmail.com",
    mobileNumber: "9734567890",
    lookingFor: "Organic Mangoes",
    locationandDate: "Mumbai 09-11-2024",
    productOrService: "Organic Mangoes",
    quantity: 150,
    unit: "kg",
  },
  {
    _id: "34567abcd89012efgh",
    name: "Rajesh Singh",
    email: "rajeshsingh@gmail.com",
    mobileNumber: "9654321098",
    lookingFor: "Mango Pulp",
    locationandDate: "Bangalore 09-11-2024",
    productOrService: "Mango Pulp",
    quantity: 300,
    unit: "kg",
  },
];
...
const MangoBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`mangoViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `mangoViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = MangoBuyers[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            <h3>All Category</h3>
            <li>
              <Link to="#">Fresh Mangoes</Link>
            </li>
            <li>
              <Link to="#">Ripe Mangoes</Link>
            </li>
            <li>
              <Link to="#">Mango Pulp</Link>
            </li>
          </ul>
        </div>
        <div className="buyers">
          {MangoBuyers.map((buyer, index) => (
