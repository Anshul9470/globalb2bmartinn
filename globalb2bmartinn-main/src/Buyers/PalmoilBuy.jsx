...
const PalmOilBuys = [
    {
        ...
        "lookingFor": "Bulk Palm Oil",
        "locationandDate": "03-07-2024",
        "productOrService": "palm oil",
        "quantity": 100,
        "unit": "kg"
    },
    {
        "name": "Prashant Chowdhary",
        "email": "prashant.sapphire@gmail.com",
        "mobileNumber": "8276028528",
        "lookingFor": "Palm Oil Supplier",
        "locationandDate": "03-07-2024",
        "productOrService": "palm oil",
        "quantity": 1000,
        "unit": "kg"
    },
    {
        ...
        "email": "sujeetkumar41d@gmail.com",
        "mobileNumber": "7561983539",
        "lookingFor": "Large Quantity Palm Oil",
        "locationandDate": "03-07-2024",
        "productOrService": "palm oil",
        "quantity": 50,
        "unit": "ton"
    },
    {
        ...
        "mobileNumber": "8273783019",
        "lookingFor": "High Volume Palm Oil",
        "locationandDate": "03-07-2024",
        "productOrService": "palm oil",
        "quantity": 100000,
        "unit": "kg"
    ...
    {
        "name": ": Md INTIYAZ",
        "email": "mdintiyaz21@gmail.com",
        "mobileNumber": "8235374478",
        "lookingFor": "Palm Oil Purchase",
        "locationandDate": "03-07-2024",
        "productOrService": "palm oil",
        "quantity": 300,
        "unit": "kg"
...
const PalmOilBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`palmOilViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`palmOilViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = PalmOilBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        ...
                        <li><Link to="#">Palm Oil</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {PalmOilBuys.map((buyer, index) => (
