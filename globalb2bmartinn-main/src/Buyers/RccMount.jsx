...
const RccCompoundWallBuys = [
    {
        "name": "sharik",
        "email": "sharik@gmail.com",
        "mobileNumber": "8005531054",
        "lookingFor": "Rcc Compound Wall",
        "locationandDate": "Bhiwadi 04-07-2024",
        "productOrService": "Rcc Compound Wall",
        "quantity": 50000,
        "unit": "meter"
    },
    {
        "name": "ganesh",
        "email": "ganesh589@gmail.com",
        "mobileNumber": "8197464646",
        "lookingFor": "RCC Poles",
        "locationandDate": "Bangalore 04-07-2024",
        "productOrService": "RCC Poles",
        "quantity": 500,
        "unit": "pcs"
    }
...
const RccCompoundWallBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`rccCompoundWallViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`rccCompoundWallViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = RccCompoundWallBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {RccCompoundWallBuys.map((buyer, index) => (
...
export default RccCompoundWallBuy;
