...
const MoringaDryLeavesBuys = [
    {
        "name": "Vidula",
        "email": "agrotechgreenland@gmail.com",
        "mobileNumber": "7057419398",
        "lookingFor": "Moringa Dry Leaves Urgently required",
        "locationandDate": "Maharashtra 05-07-2024",
        "productOrService": "Moringa Dry Leaves",
        "quantity": 10,
        "unit": "ton"
    }
];

const MoringaDryLeavesBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`moringaDryLeavesViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`moringaDryLeavesViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = MoringaDryLeavesBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {MoringaDryLeavesBuys.map((buyer, index) => (
...
export default MoringaDryLeavesBuy;
