...
const FillerMasterbatchBuys = [
    {
        "_id": "66869a299f2cecbc7cc11436",
        "name": "Daksh",
        "email": "dakshrajbhalla@gmail.com",
        "mobileNumber": "9205999713",
        "lookingFor": "FILLER MASTERBATCH, CALCIUM CARBONATE POWDER",
        "locationandDate": "Delhi 11-08-2024",
        "productOrService": "FILLER MASTERBATCH, CALCIUM CARBONATE POWDER",
        "quantity": 100,
        "unit": "kg"
    }
];

const FillerMasterbatchBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`fillerMasterbatchViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`fillerMasterbatchViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = FillerMasterbatchBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {FillerMasterbatchBuys.map((buyer, index) => (
...
export default FillerMasterbatchBuy;
