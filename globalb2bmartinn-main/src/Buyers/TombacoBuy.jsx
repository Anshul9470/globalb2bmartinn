...
const TobaccoLeavesBuys = [
    {
        "name": "Nishant",
        "email": "nishantimpex95@gmail.com",
        "mobileNumber": "7023851569",
        "lookingFor": "Tobacco Leaves",
        "locationandDate": "Rajasthan 05-07-2024",
        "productOrService": "Tobacco Leaves",
        "quantity": 100,
        "unit": "kg"
    }
];

const TobaccoLeavesBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`tobaccoViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`tobaccoViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = TobaccoLeavesBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {TobaccoLeavesBuys.map((buyer, index) => (
...
export default TobaccoLeavesBuy;
