...
const BlackPepperBuys = [
    {
        "name": "R. Satheesh",
        "email": "rsatheesh213@gmail.com",
        "mobileNumber": "9865655834",
        "lookingFor": "Seeking high-quality black pepper urgently.",
        "locationandDate": "Mysuru 12-07-2024",
...
const BlackPepperBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`blackPepperViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`blackPepperViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = BlackPepperBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {BlackPepperBuys.map((buyer, index) => (
