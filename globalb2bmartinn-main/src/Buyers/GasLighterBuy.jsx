...
const GasLighterBuys = [
    {
        "name": "Devender",
        "email": "devender@gmail.com",
        "mobileNumber": "9740209518",
        "locationandDate": "Bangalore, 20-07-2024",
        "lookingFor": "Looking for high-quality Gas Lighter suppliers!",
        "productOrService": "Gas Lighter",
        "quantity": 1000,
        "unit": "pcs",
        "_id": "unique_id_for_gas_lighter_buyer"
    },
];
...
const GasLighterBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`gasLighterViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`gasLighterViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = GasLighterBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        <h3>All Category</h3>
                        <li><Link to="#">Gas Lighter</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {GasLighterBuys.map((buyer, index) => (
