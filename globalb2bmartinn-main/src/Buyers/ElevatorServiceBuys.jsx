...
const ElevatorServiceBuys = [
  {
    _id: "670caff7a09243af7bac04e1", // unique ID
    name: "Liladhar Enterprice",
    email: "liladharenterprice@gmail.com",
    mobileNumber: "+919674856212",
    lookingFor: "Urgently required Elevator Services",
    locationandDate: "Delhi 13-10-2024",
    productOrService: "Elevator services",
    quantity: 1,
    unit: "pcs",
  },
  {
    _id: "670caff7a09243af7bac04e2", // unique ID
    name: "Basha",
    email: "lalit.dora92@gmail.com",
    mobileNumber: "+917458954856",
    lookingFor: "Immediate requirement for Elevator Services",
    locationandDate: "Noida 13-10-2024",
    productOrService: "Elevator services",
    quantity: 4,
    unit: "pcs",
  },
  ...
  {
    _id: "66869a299f2cecbc7cc11434", // unique ID
    name: "Lalit",
    email: "kingpure89@gmail.com",
    mobileNumber: "+919632589741",
    lookingFor: "Urgently required Elevator Services",
...
const ElevatorServiceBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(
        localStorage.getItem(`elevatorServiceViewedLeads_${userId}`)
      ) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `elevatorServiceViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = ElevatorServiceBuys[index]; // Get the buyer information
    ...
    <>
      ...
      <div className="containersx">
        ...
        <div className="buyers">
          {ElevatorServiceBuys.map((buyer, index) => (
...
export default ElevatorServiceBuy;
