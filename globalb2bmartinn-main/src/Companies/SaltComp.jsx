...
const SaltComp = () => {
    ...
    // Sample data for Salt Company
    const saltCompany = {
        name: "Mohommad Sikandar",
        companyName: "Sk Industry",
        productOrService: "Salt",
        productDescribe: 'Sk Industry specializes in the production and distribution of high-quality salt, offering a range of products for various uses.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Edible Salt, Industrial Salt, Bath Salts, Salt Lamps",
        ourSite: '',
        logoUrl: "/assets/sal2.jpg" // Example path to company logo image,
        ...
        <>
            ...
            <div className="b2b-page">
                <div className="content-left">
                    {/* Display Salt Company information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={saltCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{saltCompany.companyName}</h3>
                                <p><strong>Name:</strong> {saltCompany.name}</p>
                                <p><strong>Description:</strong> {saltCompany.productDescribe}</p>
                                <p><strong>Our Website:</strong> {saltCompany.ourSite}</p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {saltCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {saltCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
