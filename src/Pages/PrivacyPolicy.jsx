  ...
  return (
    <>
      <div className="privacy-section">
        ...
        <h3 style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', justifyContent: 'center' }}>Definitions</h3>
        <p>For the purposes of this Privacy Policy:</p>
        <ul>
          <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
          <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where “control” means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
          <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Global B2B Market Place.</li>
          ...
          <li><strong>Website</strong> refers to Global B2B Market Place, accessible from <a href="https://www.globalb2bmart.com/">https://www.globalb2bmart.com/</a></li>
        ...
        <ul>
          <li>By visiting this page on our website: <a href="https://globalb2bmart.com/privacy-policy" target="_blank" rel="noopener noreferrer">https://globalb2bmart.com/privacy-policy</a></li>
        </ul>
      </div>
    </>
  )
