...
const KaivalyaOrganicsComp = () => {
    ...
    const companyData = {
        ...
        productDescribe: "KAIVALYA ORGANICS PVT.LTD. specializes in high-quality pulses and other agro products. Our offerings include a variety of pulses, lentils, and grains to meet diverse agricultural needs.",
        businessType: "Manufacturer",
        mainProducts: "Pulses, Lentils, Grains",
        logoUrl: "/assets/pulses.jpg", // Example path to company logo image
    };
        ...
        <>
            ...
            <div className="b2b-page">
                <div className="content-left">
                    {/* Display KAIVALYA ORGANICS PVT.LTD. information */}
