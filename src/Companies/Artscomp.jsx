...
const ArtsComp = () => {
    ...
    const artsCompany = {
        ...
        productDescribe: 'Prem Arts specializes in offering a wide range of high-quality art pieces, including paintings, sculptures, and custom artworks.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Paintings, Sculptures, Custom Artworks",
        oursite: '',
        ...
        <>
            ...
            <div className="b2b-page">
                ...
                <div className="content-left">
                    {/* Display Prem Arts information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={artsCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{artsCompany.companyName}</h3>
                                <p><strong>Name:</strong> {artsCompany.name}</p>
                                <p><strong>Description:</strong> {artsCompany.productDescribe}</p>
                                <p><strong>Our Website:</strong> {artsCompany.oursite}</p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {artsCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {artsCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
