...
const AnitaTextileComp = () => {
  const companyData = {
    ...
    productDescribe:
      "Anita Textile specializes in high-quality textiles and fabrics, offering a diverse range of products to meet the needs of various industries. Our commitment to quality ensures that our materials are durable and reliable.",
    businessType: "Supplier",
    mainProducts: "Textile, Fabric",
    logoUrl: "/assets/textile_logo.jpg", // Example path to company logo/image
...
export default AnitaTextileComp;
