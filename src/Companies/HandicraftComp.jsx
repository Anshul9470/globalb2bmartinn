...
const HandicraftComp = () => {
    ...
    // Sample data for Handicraft Company
    const handicraftCompany = {
        name: "4 Ever Handicraft",
        companyName: "4 Ever Handicraft",
        productOrService: "Handicraft items",
        productDescribe: '4 Ever Handicraft specializes in exquisite handmade items, offering unique and artistic solutions for decor and gifting purposes.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Wooden crafts, Metal crafts, Textile crafts, Ceramic crafts",
        logoUrl: "/assets/hand.avif" // Example path to company logo image
    };
        ...
        <>
            ...
            <div className="b2b-page">
                <div className="content-left">
                    {/* Display Handicraft Company information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={handicraftCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{handicraftCompany.companyName}</h3>
                                <p><strong>Name:</strong> {handicraftCompany.name}</p>
                                <p><strong>Description:</strong>   {handicraftCompany.productDescribe} </p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {handicraftCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {handicraftCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
