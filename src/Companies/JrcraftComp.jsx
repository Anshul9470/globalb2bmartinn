...
const JRCraftComp = () => {
    ...
    // Sample data for JR Crafts India
    const jrCraftCompany = {
        name: "Parveen",
        companyName: "JR Crafts India",
        productOrService: "Marble Decorative Items",
        productDescribe: 'JR Crafts India specializes in exquisite marble decorative items, adding elegance and luxury to any space.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Marble Statues, Marble Furniture, Marble Artifacts",
        ...
        <>
            ...
            <div className="b2b-page">
                <div className="content-left">
                    {/* Display JR Crafts India information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={jrCraftCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{jrCraftCompany.companyName}</h3>
                                <p><strong>Name:</strong> {jrCraftCompany.name}</p>
                                <p><strong>Description:</strong> {jrCraftCompany.productDescribe}</p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {jrCraftCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {jrCraftCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
