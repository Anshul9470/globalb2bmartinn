...
const SeatCoverComp = () => {
    ...
    // Sample data for Seat Cover Company
    const seatCoverCompany = {
        name: "Bhupender",
        companyName: "Ridhyansh Enterprises",
        productOrService: "Seat Covers",
        productDescribe: 'Ridhyansh Enterprises specializes in high-quality seat covers, providing durable and stylish solutions for vehicle interiors.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Car Seat Covers, Bike Seat Covers, Custom Seat Covers",
        logoUrl: "/assets/cov3.jpg" // Example path to company logo image
    };
        ...
        <>
            ...
            <div className="b2b-page">
                <div className="content-left">
                    {/* Display Seat Cover Company information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={seatCoverCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{seatCoverCompany.companyName}</h3>
                                <p><strong>Name:</strong> {seatCoverCompany.name}</p>
                                <p><strong>Description:</strong> {seatCoverCompany.productDescribe}</p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {seatCoverCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {seatCoverCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
