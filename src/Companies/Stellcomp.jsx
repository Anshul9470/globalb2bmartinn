...
const SteelCompany = () => {
    ...
    // Data for Mamta Steel Center
    const plasticCompany = {
        name: "Chetan Jain",
        companyName: "Mamta Steel Center",
        productOrService: "Utensils",
        productDescribe: 'Mamta Steel Center specializes in offering a wide range of high-quality utensils for various kitchen needs.',
        businessType: "Manufacturer, Trading Company",
        mainProducts: "Stainless Steel Utensils, Cookware, Kitchen Accessories",
        ourWebsite: '',
        ...
        <>
            ...
            <div className="b2b-page">
                ...
                <div className="content-left">
                    {/* Display Mamta Steel Center information */}
                    <div className="company-card">
                        <div className="company-header">
                            <div className="company-logo">
                                <img src={plasticCompany.logoUrl} alt="Company Logo" />
                            </div>
                            <div className="company-details">
                                <h3>{plasticCompany.companyName}</h3>
                                <p><strong>Name:</strong> {plasticCompany.name}</p>
                                <p><strong>Description:</strong> {plasticCompany.productDescribe}</p>
                                <p><strong>Our Website:</strong> {plasticCompany.ourWebsite}</p>
                        ...
                        <div className="company-description">
                            <p><strong>Business Type:</strong> {plasticCompany.businessType}</p>
                            <p><strong>Main Products:</strong> {plasticCompany.mainProducts}</p>
                        </div>
                    </div>
                </div>
