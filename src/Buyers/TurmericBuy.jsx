...
const TurmericBuys = [
    {
        "name": "Sharadendu S Katke",
        "email": "katke.sharadendu@gmail.com",
        "mobileNumber": "9482151049",
        "locationandDate": "Nizamabad, Telangana, 23-08-2024",
        "lookingFor": "high-quality Turmeric Finger Required!",
        "productOrService": "Turmeric Finger",
        "quantity": 80,
        "unit": "tons",
        "_id": "unique_id_for_turmeric_finger_buyer"
    },
    {
        "name": "SUMAN MANNA",
        "email": "mannabubai@gmail.com",
        "mobileNumber": "8945526666",
        "locationandDate": "Hooghly, West Bengal, 23-08-2024",
        "lookingFor": "Looking for Urgently Turmeric suppliers!",
        "productOrService": "Turmeric",
        "quantity": 2,
        "unit": "tons",
        "_id": "unique_id_for_turmeric_buyer",
        "__v": 0
    },
    ...
    {
        "name": "Karan",
        "email": "karanvarshney66062@gmail.com",
        "mobileNumber": "9368495082",
        "locationandDate": "Sangli, 18-07-2024",
        "lookingFor": "Looking for high-quality Turmeric suppliers!",
        "productOrService": "Turmeric",
        "quantity": 10,
        "unit": "tons",
        "_id": "unique_id_for_turmeric_buyer"
...
const TurmericBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`turmericViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`turmericViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = TurmericBuys[index]; // Get the buyer information
