...
const CloveBuys = [
    {
        "name": "Sayyed Shafie Rahiman",
        "email": "shafi235711@gmail.com",
        "mobileNumber": "9742638086",
        "lookingFor": "Seeking high-quality cloves urgently.",
        "locationandDate": "Koppal 09-07-2024",
        "productOrService": "cloves",
        "quantity": 50,
        "unit": "kg",
        "__v": 0
    },
    {
        "_id": "668bde4d9f2cecbc7cc1149d",
        "name": "Digvijay Kashyap",
        "email": "digvijay.kashyap@gmail.com",
        "mobileNumber": "9920179210",
        "lookingFor": "Looking for bulk quantity of cloves.",
        "locationandDate": "Pune 09-07-2024",
        "productOrService": "cloves",
        "quantity": 50,
        "unit": "ton",
        "__v": 0
    ...
    {
        "name": "Amit,Pandey",
        "email": "info@apspexports.com",
        "mobileNumber": "9839053428",
        "lookingFor": "Cloves Supplier Required Urgently",
        "locationandDate": "Kanpur Nagar 09-07-2024",
        "productOrService": "cloves",
        "quantity": 100,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdef49f2cecbc7cc114a1"
    },

    {
        "name": "ABU REHAN ALAM",
        "email": "ehanalam577@gmail.com",
        "mobileNumber": "7501628900",
        "lookingFor": "Small Batch Cloves Needed",
        "locationandDate": "Kerala 09-07-2024",
        "productOrService": "cloves",
        "quantity": 10,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdf379f2cecbc7cc114a3"
    },

    {
        "name": "Naval pandole",
        "email": "navalpandole5@gmail.com",
        "mobileNumber": "8237588373",
        "lookingFor": "Cloves for Spices Production",
        "locationandDate": "Chikmagalur 09-07-2024",
        "productOrService": "cloves",
        "quantity": 20,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdf7d9f2cecbc7cc114a5"
    },

    {
        "name": "Balaubramanian m",
        "email": "quillingtutorial@gmail.com",
        "mobileNumber": "7550155266",
        "lookingFor": "Bulk Cloves for Export",
        "locationandDate": "Chennai 09-07-2024",
        "productOrService": "cloves",
        "quantity": 100,
        "unit": "ton",
        "__v": 0,
        "_id": "668bdf7d9f2cecbc7cc114a7"
    }
...
const CloveBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`cloveViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`cloveViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = CloveBuys[index]; // Get the buyer information
