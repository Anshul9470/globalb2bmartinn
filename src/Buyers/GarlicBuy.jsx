...
const GarlicBuys = [
    {
        "name": "YESHWANTH RAJ",
        "email": "yeshwann@gmail.com",
        "mobileNumber": "9944537956",
        "lookingFor": "Fresh Garlic",
    ...
    {
        "name": "Kaushal Datt",
        "email": "kaushaldatt5@gmail.com",
        "mobileNumber": "8894276773",
        "lookingFor": "Reselling Purpose",
        "locationandDate": "03-07-2024",
        "productOrService": "garlic",
        "quantity": 5000,
        "unit": "kg"
    ...
    {
        "name": "Saravanan",
        "email": "ravanansaran6@gamail.com",
        "mobileNumber": "7845748457",
        "lookingFor": "Garlic Whole Sale Dealer",
        "productOrService": "garlic",
        "locationandDate": "03-07-2024",
        "quantity": 1,
        "unit": "ton"
    ...
    {
        "name": "Syed ,Umar",
        "email": "umarsyed75@gmail.com",
        "mobileNumber": "9632003223",
        "lookingFor": "Required Fresh Garlic",
        "productOrService": "garlic",
        "locationandDate": "03-07-2024",
        "quantity": 100,
        "unit": "kg"
...
const GarlicBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`garlicViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`garlicViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = GarlicBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        <h3>All Category</h3>
                        <li><Link to="#">Garlic</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {GarlicBuys.map((buyer, index) => (
