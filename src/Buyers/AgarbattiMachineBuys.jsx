...
const AgarbattiMachineBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`agarbattiMachineViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`agarbattiMachineViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = AgarbattiMachineBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {AgarbattiMachineBuys.map((buyer, index) => (
...
export default AgarbattiMachineBuy;
