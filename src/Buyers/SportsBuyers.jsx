...
import "./OnionBuy.css"; // Assuming a new CSS file for sports equipment buyer styles
import { useAuth } from "./AuthContext";
import { Link } from "react-router-dom";
import Whyglobal from "../Components/Whyglobal";
import BuyerSide from "./BuyerSidebuyer";

const SportsEquipmentBuys = [
  {
    name: "Vikram Singh",
    email: "vikram.singh@gmail.com",
    mobileNumber: "9876543210",
    locationandDate: "Delhi, 19-11-2024",
    lookingFor: "Looking for bulk order of gym equipment for fitness center!",
    productOrService: "Gym Equipment",
    quantity: 15,
    unit: "pieces",
    _id: "unique_id_for_gym_equipment_buyer_1",
  },
  {
    name: "Priya Mehra",
    email: "priya.mehra@gmail.com",
    mobileNumber: "9900112233",
    lookingFor: "Need cricket bats and balls in bulk for sports shop",
    productOrService: "Cricket Equipment",
  ...
  },
  {
    ...
    lookingFor: "Looking for soccer balls and nets for sports academy",
    productOrService: "Soccer Equipment",
  ...
  },
  {
    ...
    lookingFor: "Looking for badminton rackets and shuttlecocks in bulk",
    productOrService: "Badminton Equipment",
  ...
  },
  {
    ...
    lookingFor: "Looking for tennis rackets and balls for academy",
    productOrService: "Tennis Equipment",
...
const SportsEquipmentBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(
        localStorage.getItem(`sportsEquipmentViewedLeads_${userId}`)
      ) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `sportsEquipmentViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = SportsEquipmentBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            ...
            <li>
              <Link to="#">Cricket Equipment</Link>
            </li>
            <li>
              <Link to="#">Soccer Equipment</Link>
            </li>
            <li>
              <Link to="#">Badminton Equipment</Link>
            </li>
            <li>
              <Link to="#">Tennis Equipment</Link>
            </li>
          </ul>
        </div>
        <div className="buyers">
          {SportsEquipmentBuys.map((buyer, index) => (
...
export default SportsEquipmentBuy;
