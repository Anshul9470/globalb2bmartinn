...
const PlasticContainerBuys = [
    {
        "name": "Swarup Chakraborty",
        "email": "swarupanurag.c@rediffmail.com",
        "mobileNumber": "8334047824",
        "locationandDate": "03-07-2024",
        "lookingFor": "Plastic Container Reselling Purpose",
        "productOrService": "black plastic round food containers",
        "quantity": 5000,
        "unit": "pcs"
    },
    {
        "name": "Svaroop",
        "email": "svaroopaipanjiguly@gmail.com",
        "mobileNumber": "9945689132",
        "lookingFor": "Plastic Containers",
        "locationandDate": "03-07-2024",
        "productOrService": "plastic round food containers",
        "quantity": 10000,
        "unit": "pcs"
    }
];

const PlasticContainerBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`plasticContainerViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`plasticContainerViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = PlasticContainerBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        <h3>All Category</h3>
                        <li><Link to="#">Plastic Containers</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {PlasticContainerBuys.map((buyer, index) => (
...
export default PlasticContainerBuy;
