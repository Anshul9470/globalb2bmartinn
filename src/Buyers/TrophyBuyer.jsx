...
import "./OnionBuy.css"; // Reuse or create a new CSS file as per your need
import { useAuth } from "./AuthContext";
import { Link } from "react-router-dom";
import Whyglobal from "../Components/Whyglobal";

// Sample random data for trophy buyers
const TrophyBuys = [
  {
    _id: "77123a299f2cecbc7cc11433",
    name: "Amit Kapoor",
    email: "amit.kapoor123@gmail.com",
    mobileNumber: "9087654321",
    lookingFor: "Custom Gold Trophy",
    locationandDate: "Mumbai 22-10-2024",
    productOrService: "Trophy Supplier",
    quantity: 50,
    unit: "pcs",
  },
  {
    _id: "77123a299f2cecbc7cc11434",
    name: "Sonia Verma",
    email: "sonia.verma567@gmail.com",
    mobileNumber: "9876543210",
    lookingFor: "Silver Sports Trophy",
    locationandDate: "Delhi 22-10-2024",
    productOrService: "Sports Trophy Distributor",
    quantity: 100,
    unit: "pcs",
  },
  {
    _id: "77123a299f2cecbc7cc11435",
    name: "Rajesh Mehra",
    email: "rajesh.mehra876@gmail.com",
    mobileNumber: "9098765432",
    lookingFor: "Award Plaques",
    locationandDate: "Bangalore 22-10-2024",
    productOrService: "Award Supplier",
    quantity: 200,
    unit: "pcs",
  },
  {
    _id: "77123a299f2cecbc7cc11436",
    name: "Divya Sharma",
    email: "divya.sharma789@gmail.com",
    mobileNumber: "9234567890",
    lookingFor: "Crystal Trophy",
    locationandDate: "Hyderabad 21-10-2024",
    productOrService: "Crystal Trophy Manufacturer",
    quantity: 75,
    unit: "pcs",
  },
];
...
const TrophyBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`trophyViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `trophyViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = TrophyBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            <h3>All Category</h3>
            <li>
              <Link to="#">Sports Trophies</Link>
            </li>
            <li>
              <Link to="#">Custom Trophies</Link>
            </li>
            <li>
              <Link to="#">Plaques</Link>
            </li>
            <li>
              <Link to="#">Crystal Trophies</Link>
            </li>
          </ul>
        </div>
        <div className="buyers">
          {TrophyBuys.map((buyer, index) => (
            <div key={index} className="buyer-card">
              ...
              {/* <p style={{ color: "red" }}>
                <strong>URGENT:</strong> This buyer is looking to make a
                purchase immediately. Act fast to secure the lead!
              </p> */}
              <p>
