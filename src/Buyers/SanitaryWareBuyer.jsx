...
const SanitaryWareBuys = [
  {
    _id: "66869a299f2cecbc7cc11443",
    name: "Navneet Sharma",
    email: "navneetsharma@gmail.com",
    mobileNumber: "+919658745896",
    lookingFor: "Looking to purchase Sanitary Wares for a large project.",
    locationandDate: "Mumbai 17-10-2024",
    productOrService: "Sanitary Wares",
    quantity: 1,
    unit: "container",
  },
  {
    ...
    name: "Binod Kumar",
    email: "binodkumar@gmail.com",
    mobileNumber: "+919478548596",
    lookingFor: "Bulk purchase of Sanitary Ware for wholesale distribution.",
    locationandDate: "Botad 18-10-2024",
...
const SanitaryWareBuyer = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`sanitaryWareViewedLeads_${userId}`)) ||
      [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `sanitaryWareViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = SanitaryWareBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul className="flt-list cust-scroll" id="category-lists">
            <li>
              <Link to="#">All Sanitary Wares</Link>
            </li>
            <li>
              <Link to="#">Sanitary Fittings</Link>
            </li>
            <li>
              <Link to="#">Sanitary Accessories</Link>
            </li>
          </ul>
        </div>
        <div className="buyers">
          {SanitaryWareBuys.map((buyer, index) => (
...
export default SanitaryWareBuyer;
