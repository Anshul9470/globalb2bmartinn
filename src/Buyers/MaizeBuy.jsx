...
const MaizeBuys = [
    {
        "name": "V S Agrotech",
        "email": "vsagrotech81@gmail.com",
        "mobileNumber": "9437385407",
        "lookingFor": "High Quality Maize",
        "locationandDate": "03-07-2024",
        "productOrService": "maize",
        "quantity": 5,
        "unit": "ton"
    },
    {
        "name": "Charan,Thez",
        "email": "voletirccharanthez@gmail.com",
        "mobileNumber": "8686511125",
        "lookingFor": "Bulk Maize Purchase",
        "locationandDate": "03-07-2024",
        "productOrService": "maize",
        "quantity": 5000,
        "unit": "ton"
    ...
    {
        "name": "Shahul,User",
        "email": "shahul.191996@gmail.com",
        "mobileNumber": "8779170264",
        "lookingFor": "Wholesale Maize",
        "productOrService": "maize",
        "locationandDate": "03-07-2024",
        "quantity": 500,
        "unit": "ton"
    ...
    {
        "name": ": CCharanthez",
        "email": "charanthezvoleti@gmail.com",
        "mobileNumber": "8686511125",
        "lookingFor": "Large Maize Quantities",
        "productOrService": "maize",
        "locationandDate": "03-07-2024",
        "quantity": 2500,
        "unit": "ton"
    ...
    {
        "name": "Sehaj",
        "email": "js7311285@gmail.com",
        "mobileNumber": "6280273512",
        "lookingFor": "Small Maize Supply",
        "productOrService": "maize",
        "locationandDate": "03-07-2024",
        "quantity": 100,
        "unit": "kg"
...
const MaizeBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`maizeViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`maizeViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = MaizeBuys[index]; // Get the buyer information
