...
import "./OnionBuy.css"; // Use or create a new CSS file as per your need
import { useAuth } from "./AuthContext";
import { Link } from "react-router-dom";
import Whyglobal from "../Components/Whyglobal";

// Sample random data for bat buyers
const BatBuys = [
  {
    _id: "88123b399f2cecbc7cc11437",
    name: "Ravi Singh",
    email: "ravi.singh12@gmail.com",
    mobileNumber: "9123456789",
    lookingFor: "English Willow Cricket Bat",
    locationandDate: "Pune 19-10-2024",
    productOrService: "Cricket Bat Supplier",
    quantity: 20,
    unit: "pcs",
  },
  {
    _id: "88123b399f2cecbc7cc11438",
    name: "Priya Sharma",
    email: "priya.sharma123@gmail.com",
    mobileNumber: "9876541230",
    lookingFor: "Kashmir Willow Bat",
    locationandDate: "Jaipur 16-10-2024",
    productOrService: "Sports Equipment Distributor",
    quantity: 50,
    unit: "pcs",
  },
  {
    _id: "88123b399f2cecbc7cc11439",
    name: "Manish Thakur",
    email: "manish.thakur456@gmail.com",
    mobileNumber: "9098765432",
    lookingFor: "Custom Branded Bats",
    locationandDate: "Bangalore 14-10-2024",
    productOrService: "Bat Manufacturer",
    quantity: 100,
    unit: "pcs",
  },
  {
    _id: "88123b399f2cecbc7cc11440",
    name: "Alok Verma",
    email: "alok.verma789@gmail.com",
    mobileNumber: "9234567890",
    lookingFor: "Professional Cricket Bat",
    locationandDate: "Kolkata 12-10-2024",
    productOrService: "Sports Supplier",
    quantity: 30,
    unit: "pcs",
  },
];
...
const BatBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`batViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `batViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = BatBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            <h3>All Category</h3>
            <li>
              <Link to="#">Willow Bats</Link>
            </li>
            <li>
              <Link to="#">Custom Bats</Link>
            </li>
            <li>
              <Link to="#">Professional Bats</Link>
            </li>
            <li>
        ...
        <div className="buyers">
          {BatBuys.map((buyer, index) => (
            <div key={index} className="buyer-card">
              ...
              {/* <p style={{ color: "red" }}>
                <strong>URGENT:</strong> This buyer needs the product urgently.
                Contact now to close the deal fast!
              </p> */}
              <p>
