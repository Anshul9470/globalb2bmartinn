...
const EyeDropsBuys = [
    {
        "name": "mercury pharmaceuticals",
        "email": "mercurypharmaceuticalsindia@gmail.com",
        "mobileNumber": "7347613332",
        "lookingFor": "Eye Drops",
        "locationandDate": "04-07-2024",
        "productOrService": "eye drops",
        "quantity": 100,
        "unit": "units"
    }
];
...
const EyeDropsBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`eyeDropsViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`eyeDropsViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = EyeDropsBuys[index]; // Get the buyer information
