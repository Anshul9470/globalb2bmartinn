...
const FreshGreenChilliBuys = [
    {
        "name": "krishna",
        "email": "anvrbmk@gmail.com",
        "mobileNumber": "9866474555",
        "lookingFor": "Seeking bulk purchase for spicy processing",
        "locationandDate": "Hyderabad 19-07-2024",
    ...
    {
        "name": "Abhishek SG",
        "email": "abhishek21sg@gmail.com",
        "mobileNumber": "8904542496",
        "lookingFor": "In need of bulk red chili powder for fiery flavors",
        "locationandDate": "Bangalore 19-07-2024",
        "productOrService": "Red Chili Powder",
        "quantity": 100,
        "unit": "ton",
        "__v": 0
    },
    {
        ...
        "email": "anvrbmk@gmail.com",
        "mobileNumber": "9866474555",
        "lookingFor": "Need red chilli in bulk.",
        "locationandDate": "Hyderabad 12-07-2024",
        "productOrService": "Red Chilli",
        "quantity": 25,
        "unit": "ton",
        "__v": 0
    ...
    {
        "name": "nizamuddinn",
        "email": "nizamuddinnng7@gmail.com",
        "mobileNumber": "9901671292",
        "lookingFor": "Fresh Green Chilli",
        "locationandDate": "Bangalore 04-07-2024",
        "productOrService": "Fresh Green Chilli",
        "quantity": 12,
        "unit": "ton"
    }
];

const FreshGreenChilliBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`freshGreenChilliViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`freshGreenChilliViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = FreshGreenChilliBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {FreshGreenChilliBuys.map((buyer, index) => (
...
export default FreshGreenChilliBuy;
