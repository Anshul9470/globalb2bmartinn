...
// Sample random data for shoes buyers
const ShoesBuys = [
  {
    _id: "66901a299f2cecbc7cc12345",
    name: "Ravi Kumar",
    email: "ravi.kumar@gmail.com",
    mobileNumber: "9876543210",
    lookingFor: "Bulk Purchase: High Quality Sports Shoes Required",
    locationandDate: "Mumbai, 07-11-2024",
    productOrService: "Shoes Supplier",
    quantity: 1000,
    unit: "pairs",
  },
  {
    _id: "66901a299f2cecbc7cc12346",
    name: "Priya Sharma",
    email: "priya.sharma@gmail.com",
    mobileNumber: "9998765432",
    lookingFor: "Bulk Purchase: Formal Leather Shoes for Men",
  ...
  {
    _id: "66901a299f2cecbc7cc12347",
    name: "Amit Verma",
    email: "amit.verma@gmail.com",
    mobileNumber: "9812345678",
    lookingFor: "Bulk Purchase: Children's Shoes (Various Sizes)",
  ...
  {
    _id: "66901a299f2cecbc7cc12348",
    name: "Anjali Singh",
    email: "anjali.singh@gmail.com",
    mobileNumber: "9734567890",
    lookingFor: "Bulk Purchase: Hiking Shoes for Adults",
  ...
  {
    _id: "66901a299f2cecbc7cc12349",
    name: "Neha Gupta",
    email: "neha.gupta@gmail.com",
    mobileNumber: "9701234567",
    lookingFor: "Bulk Purchase: Women's Casual Shoes",
...
const ShoesBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`shoesViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `shoesViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = ShoesBuys[index]; // Get the buyer information
    ...
    <>
      <div className="container">
        <ol className="breadcrumb">
          ...
          <li>/</li>
          <li className="breadcrumb-item active">Shoes Leads</li>
        </ol>
      </div>
