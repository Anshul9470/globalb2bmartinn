...
const RedChilliBuys = [
    {
        "name": "Store Lakshmi",
        "email": "storelakshmi@gmail.com",
        "mobileNumber": "+919846020985",
...

    {
        ...
        "email": "anvrbmk@gmail.com",
        "mobileNumber": "9866474555",
        "lookingFor": "Bulk purchase for processing",
        "locationandDate": "Hyderabad 13-07-2024",
        "productOrService": "Red Chilli",
        "quantity": 30,
        "unit": "ton",
        "__v": 0
...
const RedChilliBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`redChilliViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`redChilliViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = RedChilliBuys[index]; // Get the buyer information
