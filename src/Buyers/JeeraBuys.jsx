...
const JeeraBuys = [
    {
        "name": "amit upreti",
        "email": "guestbazar@gmail.com",
        "mobileNumber": "7895697456",
        "lookingFor": "Jeera Urgently Required",
        "locationandDate": "Uttarakhand 09-07-2024",
        "productOrService": "jeera",
        "quantity": 50000,
        "unit": "kg"
    },
    ...
    {
        "name": "Dhanusiya",
        "email": "southhallfoodi@gmail.com",
        "mobileNumber": "7417144221",
        "lookingFor": "Jeera  Required For Bulk Purchase",
        "locationandDate": "Ghaziabad 09-07-2024",
        "productOrService": "jeera",
        "quantity": 100,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdd159f2cecbc7cc11497"
    },

    {
        "name": "Deepak sahu",
        "email": "deep1030m@gmail.com",
        "mobileNumber": "9098051185",
        "lookingFor": "Jeera Required Reselling Purpose",
        "locationandDate": "Bilaspur 09-07-2024",
        "productOrService": "jeera",
        "quantity": 100,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdd5d9f2cecbc7cc11499"
    },

    {
        "name": "Chetan manhas",
        "email": "chetanmanhas91@gmail.com",
        "mobileNumber": "6280158818",
        "lookingFor": "Jeera  Required In large Quantity ",
        "locationandDate": "Pathankot 09-07-2024",
        "productOrService": "jeera",
        "quantity": 1000,
        "unit": "kg",
        "__v": 0,
        "_id": "668bdda79f2cecbc7cc1149b"
    }
...
const JeeraBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`jeeraViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`jeeraViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = JeeraBuys[index]; // Get the buyer information
