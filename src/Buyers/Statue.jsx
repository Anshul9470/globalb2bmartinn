...
const PolyresinBearBuys = [
    {
        "name": "grandma garden",
        "email": "grandmagarden1118@gmail.com",
        "mobileNumber": "9815255528",
        "lookingFor": "Polyresin Bear Statue",
        "locationandDate": "Ludhiana 04-07-2024",
        "productOrService": "Polyresin Bear Statue",
        "quantity": 40,
        "unit": "pcs"
    },
    {
        "name": "bhavna",
        "email": "bhavna.acharyalavbhushan@gmail.com",
        "mobileNumber": "9828015701",
        "lookingFor": "Polyresin Ganesha Idol urgently required",
        "locationandDate": "AddressJaipur 04-07-2024",
        "productOrService": "Polyresin Ganesha Idol",
        "quantity": 70,
        "unit": "dozen"
    },
    {
        "name": "keshav jha",
        "email": "keshavjha0006@gmail.com",
        "mobileNumber": "9958187616",
        "lookingFor": "Polyresin Statue urgently required",
        "locationandDate": "AddressDelhi 04-07-2024",
        "productOrService": "Polyresin Statue",
        "quantity": 200,
        "unit": "pcs"
    }
...
const PolyresinBearBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`polyresinBearViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`polyresinBearViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = PolyresinBearBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {PolyresinBearBuys.map((buyer, index) => (
...
export default PolyresinBearBuy;
