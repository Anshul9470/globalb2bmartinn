...
// Sample random data for scrap buyers
const ScrapBuys = [
  {
    _id: "76901a299f2cecbc7cc11460",
    name: "Rahul Mehta",
    email: "rahul.mehta@gmail.com",
    mobileNumber: "9876543210",
    lookingFor: "Buying: Iron Scrap in Bulk",
    locationandDate: "Pune, 17-10-2024",
    productOrService: "Iron Scrap Supplier",
    quantity: 100,
    unit: "tons",
  },
  {
    _id: "76901a299f2cecbc7cc11461",
    name: "Shreya Sharma",
    email: "shreya.sharma@gmail.com",
    mobileNumber: "9987654312",
    lookingFor: "Need Plastic Scrap for Recycling",
    locationandDate: "Delhi, 16-10-2024",
    productOrService: "Plastic Scrap Dealer",
    quantity: 50,
    unit: "tons",
  },
  {
    _id: "76901a299f2cecbc7cc11462",
    name: "Vijay Patel",
    email: "vijay.patel@gmail.com",
    mobileNumber: "9123456780",
    lookingFor: "Copper Scrap Urgently Required",
    locationandDate: "Ahmedabad, 15-10-2024",
    productOrService: "Copper Scrap Wholesaler",
    quantity: 200,
    unit: "tons",
  },
];
...
const ScrapBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`scrapViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `scrapViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = ScrapBuys[index]; // Get the buyer information
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul style={{ marginTop: "20px" }} className="flt-list cust-scroll">
            <h3>All Category</h3>
            <li>
              <Link to="#">Iron Scrap</Link>
            </li>
            <li>
              <Link to="#">Plastic Scrap</Link>
            </li>
            <li>
              <Link to="#">Copper Scrap</Link>
            </li>
            <li>
              <Link to="#">Aluminum Scrap</Link>
            </li>
            <li>
