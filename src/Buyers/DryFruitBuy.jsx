...
const DryFruitBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`dryFruitViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`dryFruitViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = DryFruitBuys[index]; // Get the buyer information
            ...
            <div className="containersx">
                <div style={{ width: '200px', padding: '10px' }} className="browsers">
                    ...
                    <ul style={{ marginTop: '20px' }} className="flt-list cust-scroll">
                        <h3>All Category</h3>
                        <li><Link to="#">Plastic Dry Fruit Box</Link></li>
                    </ul>
                </div>
                <div className="buyers">
                    {DryFruitBuys.map((buyer, index) => (
