...
// Sample random data for chair buyers
const ChairBuyers = [
  {
    _id: "98765ab4cd3efabc12345601",
    name: "Deepak Sharma",
    email: "deepak.sharma@gmail.com",
    mobileNumber: "9876543210",
    lookingFor: "Bulk Purchase: Office Chairs",
    locationandDate: "Delhi, 08-11-2024",
    productOrService: "Chair Supplier",
    quantity: 200,
    unit: "pieces",
  },
  {
    _id: "98765ab4cd3efabc12345602",
    name: "Neha Gupta",
    email: "neha.gupta@gmail.com",
    mobileNumber: "9988776655",
    lookingFor: "Bulk Purchase: Dining Chairs",
  ...
  {
    _id: "98765ab4cd3efabc12345603",
    name: "Amit Kumar",
    email: "amit.kumar@gmail.com",
    mobileNumber: "9912345678",
    lookingFor: "Bulk Purchase: Wooden Chairs",
  ...
  {
    _id: "98765ab4cd3efabc12345604",
    name: "Ravina Patel",
    email: "ravina.patel@gmail.com",
  ...
  {
    _id: "98765ab4cd3efabc12345605",
    name: "Sandeep Reddy",
    email: "sandeep.reddy@gmail.com",
    mobileNumber: "9812345678",
    lookingFor: "Bulk Purchase: Ergonomic Chairs",
  ...
  {
    _id: "98765ab4cd3efabc12345606",
    name: "Priya Verma",
    email: "priya.verma@gmail.com",
    mobileNumber: "9776543210",
    lookingFor: "Bulk Purchase: Plastic Chairs",
...
const ChairBuyer = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`chairViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `chairViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = ChairBuyers[index]; // Get the buyer information
    ...
    <>
      <div className="container">
        <ol className="breadcrumb">
          ...
          <li>/</li>
          <li className="breadcrumb-item active">Chair Leads</li>
        </ol>
      </div>
