...
const PeanutBuys = [
    {
        ...
        "mobileNumber": "8000162716",
        "lookingFor": "Shelled Peanuts Urgentlly required",
        "locationandDate": "Gujrat 04-07-2024",
        "productOrService": "peanuts",
        "quantity": 10,
        "unit": "ton"
    }
];
...
const PeanutBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`peanutViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`peanutViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = PeanutBuys[index]; // Get the buyer information
