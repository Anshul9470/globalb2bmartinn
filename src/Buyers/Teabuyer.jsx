...
// Sample random data for tea buyers
const TeaBuys = [
  {
    ...
    lookingFor: "Bulk Purchase: Assam Black Tea",
    locationandDate: "Delhi, 08-11-2024",
    productOrService: "Tea Supplier",
    quantity: 1000,
    unit: "kg",
  },
  {
    ...
    name: "Renu Verma",
    email: "renu.verma@gmail.com",
    mobileNumber: "9923456781",
    lookingFor: "Bulk Purchase: Green Tea Leaves",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: Darjeeling Tea",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: Organic Herbal Tea",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: Masala Chai",
  ...
  },
  {
    ...
    lookingFor: "Bulk Purchase: White Tea",
...
const TeaBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`teaViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `teaViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = TeaBuys[index]; // Get the buyer information
    ...
    <>
      <div className="container">
        <ol className="breadcrumb">
          ...
          <li>/</li>
          <li className="breadcrumb-item active">Tea Leads</li>
        </ol>
      </div>
