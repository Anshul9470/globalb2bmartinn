...
const PastaMachineBuys = [
    {
        ...
        "locationandDate": "Vellore 11-08-2024",
...
const PastaMachineBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`pastaMachineViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`pastaMachineViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = PastaMachineBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {PastaMachineBuys.map((buyer, index) => (
...
export default PastaMachineBuy;
