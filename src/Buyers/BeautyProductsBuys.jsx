...
// Sample random data for beauty products buyers
const BeautyProductsBuys = [
  {
    ...
    locationandDate: "Mumbai, 01-11-2024",
  ...
  },
  {
    ...
    locationandDate: "Delhi, 02-11-2024",
    productOrService: "Beauty Products Supplier",
    quantity: 1000,
    unit: "units",
  },
  {
    ...
    locationandDate: "Bangalore, 03-11-2024",
    productOrService: "Beauty Products Supplier",
    quantity: 2000,
    unit: "units",
  },
...
const BeautyProductsBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`beautyViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `beautyViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = BeautyProductsBuys[index]; // Get the buyer information
    ...
    <>
      <div className="container">
        <ol className="breadcrumb">
          ...
          <li>/</li>
          <li className="breadcrumb-item active">Beauty Products Leads</li>
        </ol>
      </div>
      <div className="containersx">
        ...
        <div className="buyers">
          {BeautyProductsBuys.map((buyer, index) => (
