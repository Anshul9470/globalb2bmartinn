...
const Bottlebuys = [
  {
    ...
    lookingFor: "Bulk Purchase: High Quality Glass Bottles Required",
    locationandDate: "Delhi, 23-10-2024",
    productOrService: "Bottle Supplier",
    quantity: 5000,
    unit: "pieces",
  },
  {
    ...
    lookingFor: "Urgent Requirement: Plastic Bottles in Bulk",
    locationandDate: "Ahmedabad, 23-10-2024",
    productOrService: "Bottle Dealer",
    quantity: 3000,
    unit: "pieces",
  },
  {
    ...
    lookingFor: "Immediate Need: Eco-friendly Bottles",
    locationandDate: "Bangalore, 22-10-2024",
    productOrService: "Eco Bottles Wholesaler",
    quantity: 10000,
    unit: "pieces",
  },
];
...
const Bottlebuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`bottleViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `bottleViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = Bottlebuys[index]; // Get the buyer information
