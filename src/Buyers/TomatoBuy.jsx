...
const TomatoBuys = [
    {
        "name": "ANILKUMAR",
        "email": "samk63152@gmail.com",
        "mobileNumber": "9482073085",
        "locationandDate": "28-06-2024",
        "lookingFor": "tomato",
        "productOrService": "tomato",
        "quantity": 100,
        "unit": "kg"
    }
];
...
const TomatoBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`tomatoViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`tomatoViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = TomatoBuys[index]; // Get the buyer information
