...
const PulsesBuys = [
  {
    name: "Balwant Singh",
    email: "sbalwant1969@gmail.com",
    mobileNumber: "7807248120",
    locationandDate: "Mandi, Himachal Pradesh, 23-08-2024",
    lookingFor: "Looking for high-quality Pulses suppliers!",
    productOrService: "Pulses",
    quantity: 10,
    unit: "tons",
    _id: "unique_id_for_pulses_buyer",
  },

  {
    name: "Mahendra s naik",
    email: "mahendrasnaik@gmail.com",
    mobileNumber: "7975640632",
    lookingFor: "Top-notch quality at the best price Required",
    productOrService: "Pulses",
    locationandDate: "Udupi, 10-08-2024",
    quantity: 10,
    unit: "ton",
  },

  {
    ...
    mobileNumber: "8688451525",
    lookingFor: "Pulses",
    locationandDate: "Rangareddy 10-08-2024",
    productOrService: "Pulses",
    quantity: 20,
    unit: "ton",
  },
  {
    name: "Nagaraj",
    email: "nagarajdassaiah@gmail.com",
    mobileNumber: "6366155702",
    lookingFor: "Premium pulses Required",
    productOrService: "Pulses",
    locationandDate: "Kolar, 09-08-2024",
    quantity: 200,
    unit: "ton",
  },
];
...
const PulsesBuy = () => {
  ...
  useEffect(() => {
    ...
    const storedViewedLeads =
      JSON.parse(localStorage.getItem(`pulsesViewedLeads_${userId}`)) || [];
  ...
  const toggleNumber = async (index) => {
    ...
    localStorage.setItem(
      `pulsesViewedLeads_${userId}`,
      JSON.stringify(updatedShownNumbers)
    );

    const buyer = PulsesBuys[index]; // Get the buyer information
