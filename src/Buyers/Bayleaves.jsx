...
const BayLeavesBuys = [
    {
        ...
        "name": "Anil Rasekar",
        "email": "akrasekar@gmail.com",
        "mobileNumber": "9890767167",
        "lookingFor": "Bay Leaves",
        "locationandDate": "Maharashtra 04-07-2024",
        "productOrService": "Bay Leaves",
        "quantity": 5,
        "unit": "ton"
    }
];
...
const BayLeavesBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`bayLeavesViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`bayLeavesViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = BayLeavesBuys[index]; // Get the buyer information
