...
const TshirtBuys = [
  {
    ...
    productOrService:
      "Looking for bulk purchase of T-shirts for a retail store.",
    quantity: 500,
    unit: "pieces",
  },
  {
    ...
    mobileNumber: "+919654321987",

    locationandDate: "Mumbai 18-11-2024",
    productOrService: "Urgently require T-shirts for an upcoming event.",
    quantity: 1000,
    unit: "pieces",
  },
];
      ...
      <div className="containersx">
        <div style={{ width: "200px", padding: "10px" }} className="browsers">
          ...
          <ul className="flt-list cust-scroll" id="category-lists">
            <li>
              <Link to="#">All T-shirts</Link>
            </li>
            <li>
              <Link to="#">Men's T-shirts</Link>
            </li>
            <li>
              <Link to="#">Women's T-shirts</Link>
            </li>
          </ul>
        </div>
