...
const SurgicalGlovesBuys = [
    {
        "name": "umesh rathore",
        "email": "umeshrathore350@gmail.com",
        "mobileNumber": "9039055337",
        "lookingFor": "Surgical Gloves",
        "locationandDate": "Jabalpur 04-07-2024",
        "productOrService": "Surgical Gloves",
        "quantity": 100000,
        "unit": "pcs"
    }
];

const SurgicalGlovesBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`surgicalGlovesViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`surgicalGlovesViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = SurgicalGlovesBuys[index]; // Get the buyer information
        ...
        <>
            ...
            <div className="containersx">
                ...
                <div className="buyers">
                    {SurgicalGlovesBuys.map((buyer, index) => (
...
export default SurgicalGlovesBuy;
