...
const FlourBuys = [
    {
        ...
        "name": "Girish Hattarki",
        "email": "girishhattarki@rediffmail.com",
        "mobileNumber": "9880575511",
        "lookingFor": "I Want To Buy Flour Mill",
        "locationandDate": "Belgaum 12-08-2024",
    ...
    },
    {
        "_id": "12345abcde67890fghij",
        "name": "Mallesh Harave",
        "email": "haravemallesh@gmail.com",
        "mobileNumber": "7996582056",
        "lookingFor": "Flour Required In Bulk Quantity",
        "locationandDate": "Chamarajanagar 12-08-2024",
        "productOrService": "Flour Mill",
        "quantity": 1,
        "unit": "pcs"
    }
...
const FlourBuy = () => {
    ...
    useEffect(() => {
        ...
        const storedViewedLeads = JSON.parse(localStorage.getItem(`flourViewedLeads_${userId}`)) || [];
    ...
    const toggleNumber = async (index) => {
        ...
        localStorage.setItem(`flourViewedLeads_${userId}`, JSON.stringify(updatedShownNumbers));

        const buyer = FlourBuys[index]; // Get the buyer information
