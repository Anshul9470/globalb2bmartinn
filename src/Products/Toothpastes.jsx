...
const classifiedData = [
    {
        ...
        productOrService: "Betel Leaf Toothpaste",
        imgSrc: "/assets/toothpaste1.jpg",  // Ensure the correct image path
        altText: "Betel Leaf Toothpaste - BL Brothers",
        mainProducts: "Betel Leaf Toothpaste, Herbal Products",
        years: "1 YRS",
        location: "Virudhunagar, Tamil Nadu, India",
        tooltipText: "123, Market Street, Virudhunagar, Tamil Nadu, India",
        rating: "4.5",
        ratingPercent: "90%",
        ratingsCount: "50",
        responseRate: "85%"
                    ...
                    <div className="horprd expcatg" id="expcatg">
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/oral1.jpg" width={55} height={55} alt="Oral Care" />
                                    </figure>
                                    <p className="title">Oral Care</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/herbal5.jpg" width={55} height={55} alt="Herbal Products" />
                                    </figure>
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/care1.jpg" width={55} height={55} alt="Personal Care" />
                                    </figure>
