...
const classifiedData = [
  {
    _id: "ngenious-overseas-pune",
    name: "Shrikant Bhintade",
    email: "ShrikantBhintade123@gmail.com",
    password: "Shrikant Bhintade",
    mobileNumber: "8623959372",
    companyName: "ngenious Overseas",
    statename: "Maharashtra",
    cityname: "Pune",
    productOrService: "Green Cardamom",
    imgSrc: "/assets/green-cardmom.jpg",
    mainProducts: "Green Cardamom, Spices, Herbal Products",
    altText: "ngenious Overseas - Suppliers of Green Cardamom",
    years: "1 YRS",
    location: "Pune, Maharashtra, India",
    tooltipText: "ngenious Overseas - Premium Green Cardamom Supplier",
    rating: "4.5",
    ratingPercent: "90%",
    ratingsCount: "160",
    responseRate: "92%",
  ...
  {
    _id: "cardamom-manufacture-kerla",
    name: "K Arjun Raj",
    email: "KArjunRaj@gmail.com",
    password: "12345678",
    mobileNumber: "9995907083",
    companyName: "Cardamom Manufacture",
    productOrService: "Cardamom",
    imgSrc: "/assets/cardamom1.jpg",
    mainProducts: "Cardamom",
    altText: "Cardamom Manufacture - Cardamom",
    years: "1 YRS",
    location: "Kerla, India",
    tooltipText: "Cardamom Manufacture, Cardamom, Kerla",
    rating: "4.7",
    ratingPercent: "94%",
    ratingsCount: "25",
    responseRate: "88%",
