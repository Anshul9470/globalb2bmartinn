...
// The data specific to the sugar product
const classifiedData = [
    {
        ...
        imgSrc: "/assets/sugar.jpg", // Provide the correct image path
        altText: "Sugar - Gandhi Enterprises",
        mainProducts: "Refined Sugar, Brown Sugar, Raw Sugar",
        years: "1 YRS",
        location: "Maharashtra, India",
        tooltipText: "123 Sugar Lane, Industrial Area, Maharashtra, India",
        rating: "4.5",
        ratingPercent: "90%",
        ratingsCount: "50",
        responseRate: "95%"
                    ...
                    <div className="flt-box bdrt-0">
                        ...
                        <div className="flt-content">
                            <ul className="flt-list cust-scroll">
                                <li><Link to="#">Refined Sugar</Link></li>
                                <li><Link to="#">Brown Sugar</Link></li>
                                <li><Link to="#">Raw Sugar</Link></li>
                                <li><Link to="#">Powdered Sugar</Link></li>
                                <li><Link to="#">Organic Sugar</Link></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="horprd expcatg" id="expcatg">
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugar1.jpg" width={55} height={55} alt="Refined Sugar" />
                                    </figure>
                                    <p className="title">Refined Sugar</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugar2.jpg" width={55} height={55} alt="Brown Sugar" />
                                    </figure>
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugar3.jpg" width={55} height={55} alt="Raw Sugar" />
                                    </figure>
                                    <p className="title">Raw Sugar</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugar4.jpg" width={55} height={55} alt="Powdered Sugar" />
                                    </figure>
                                    <p className="title">Powdered Sugar</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugar5.jpg" width={55} height={55} alt="Organic Sugar" />
                                    </figure>
                                    <p className="title">Organic Sugar</p>
                                </div>
                            </Link>
                        </div>
                    </div>
