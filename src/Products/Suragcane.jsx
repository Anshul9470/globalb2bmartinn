...
const classifiedData = [
    {
        name: "Abhinav Hodla",
        email: "abhihodla@gmail.com",
        mobileNumber: "9663385284",
        companyName: "Abhinav Hodla",
        productOrService: "Sugarcane",
        imgSrc: "/assets/sugarcane.jpeg",  // Ensure the correct image path
        altText: "Sugarcane - Abhinav Hodla",
        mainProducts: "Sugarcane, Organic Sugarcane, Sugarcane Juice",
        years: "1 YRS",
        location: "Andhra Pradesh, India",
        tooltipText: "25, Green Field, Agricultural Zone, Andhra Pradesh, India",
        rating: "4.7",
        ratingPercent: "94%",
        ratingsCount: "120",
        responseRate: "85%"
                    ...
                    <div className="flt-box bdrt-0">
                        ...
                        <div className="flt-content">
                            <ul className="flt-list cust-scroll">
                                <li><Link to="#">Sugarcane</Link></li>
                                <li><Link to="#">Organic Sugarcane</Link></li>
                                <li><Link to="#">Sugarcane Juice</Link></li>
                        ...
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugarcane1.jpeg" width={55} height={55} alt="Sugarcane" />
                                    </figure>
                                    <p className="title">Sugarcane</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugarcane2.jpeg" width={55} height={55} alt="Organic Sugarcane" />
                                    </figure>
                                    <p className="title">Organic Sugarcane</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugarcane3.jpeg" width={55} height={55} alt="Sugarcane Juice" />
                                    </figure>
                                    <p className="title">Sugarcane Juice</p>
                                </div>
                            </Link>
                        </div>
                        <div className="item">
                            <Link to="#">
                                <div className="horprd-box">
                                    <figure>
                                        <img src="/assets/sugarcane4.jpeg" width={55} height={55} alt="Agricultural Products" />
                                    </figure>
                                    <p className="title">Agricultural Products</p>
                                </div>
                            </Link>
                        </div>
                    </div>
